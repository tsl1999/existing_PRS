...
flex_table<-prev_cont_flextable(prevalent_EPA_contf,table_caption= "Association of PRSs with CAD (baseline CAD and CAD mortality as primary cause of death) in women")
saveRDS(flex_table,paste(data_path,"/Prevalent_CHD_EPA_contF_logistic_flex_07Aug2023.rds",sep=""))
...
png(paste(graphs_path,"/logistic/Logistic_forestplotEPA_contf_07Aug2023",".png",sep=""), res = 200, width = a[1], height = a[2], units = "cm")
print(p)
dev.off()
...
plot_FAR_gg(model_output_list,name=c("Partial","Full"),
            outcome="Prevalent_CHD_EPA_F_07Aug2023",data=data_female_up)
...
flex_table<-prev_cont_flextable(prevalent_EPA_contm,table_caption= "Association of PRSs with CAD (baseline CAD and CAD mortality as primary cause of death) in men")
saveRDS(flex_table,paste(data_path,"/Prevalent_CHD_EPA_contM_logistic_flex_07Aug2023.rds",sep=""))
...
png(paste(graphs_path,"/logistic/Logistic_forestplotEPA_contm_07Aug2023",".png",sep=""), res = 200, width = a[1], height = a[2], units = "cm")
print(p)
dev.off()
...
plot_FAR_gg(model_output_list,name=c("Partial","Full"),
            outcome="Prevalent_CHD_EPA_M_07Aug2023",data=data_male_up)
