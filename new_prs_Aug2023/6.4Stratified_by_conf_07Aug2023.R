...
data<-readRDS(paste(data_path,"/FullData_ancestry_07Aug2023.rds",sep=""))
...
for (i in 1:npgs){
  ...
  png(paste(graphs_path,"/logistic/Logistic_forestplotEPO_confounder_07Aug2023",colnames(forest_input)[1],".png",sep=""), res = 200, width = a[1], height = a[2], units = "cm")
  print(p)
  dev.off()
