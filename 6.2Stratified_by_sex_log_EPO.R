...
saveRDS(flex_table,paste(data_path,"/Prevalent_CHD_EPO_contF_logistic_flex.rds",sep=""))
...
plot_FAR_gg(model_output_list,name=c("Partial","Full"),
            outcome="Prevalent_CHD_EPO_F",data=data_female_up)
...
saveRDS(flex_table,paste(data_path,"/Prevalent_CHD_EPO_contM_logistic_flex.rds",sep=""))
...
plot_FAR_gg(model_output_list,name=c("Partial","Full"),
            outcome="Prevalent_CHD_EPO_M",data=data_male_up)
