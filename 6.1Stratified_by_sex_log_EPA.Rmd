...
```{r,include=FALSE}
model_output_partialf<-create_output_table(trainsplit = F,data_female,adjustments=partial_adjustments,outcome="prevalent_CHD_EPA",namew="partialF")

model_output_fullf<-create_output_table(trainsplit = F,data_female,adjustments=full_adjustments,outcome="prevalent_CHD_EPA",namew="fullF")
```


```{r,include=FALSE}
prevalent_EPA_contf<-combine_model_tables(tables=list(model_output_partialf,model_output_fullf),name = c("Partially adjusted","Fully adjusted"),log_cox = "log")
#saveRDS(prevalent_EPA_contf,paste(data_path,"/Prevalent_CHD_EPA_contF_logistic_13Jun2023.rds",sep=""))
```
```{r,echo=FALSE}
prev_cont_flextable(prevalent_EPA_contf)
```
...
```{r,echo=FALSE}
knitr::include_graphics(paste(graphs_path,"/logistic/Logistic_forestplotEPA_contf",".png",sep=""))
```
### decile plots

```{r,include=FALSE}
model_output_partial<-create_output_table(trainsplit = F,data_female_d,adjustments=partial_adjustments,outcome="prevalent_CHD_EPA",namew="partialF",type = "cat")

model_output_full<-create_output_table(trainsplit = F,data_female_d,adjustments=full_adjustments,outcome="prevalent_CHD_EPA",namew="fullF",type = "cat")
```
...
plot_FAR_gg(model_output_list,name=c("Partial","Full"),outcome="Prevalent_CHD_EPA_F",data=data_female_up)
```
...
```
```{r,include=FALSE}
model_output_partialm<-create_output_table(trainsplit = F,data_male,adjustments=partial_adjustments,outcome="prevalent_CHD_EPA",namew="partialM")

model_output_fullm<-create_output_table(trainsplit = F,data_male,adjustments=full_adjustments,outcome="prevalent_CHD_EPA",namew="fullM")
```

```{r,include=FALSE}
prevalent_EPA_contM<-combine_model_tables(tables=list(model_output_partialm,model_output_fullm),name = c("Partially adjusted","Fully adjusted"),log_cox = "log")
...
prev_cont_flextable(prevalent_EPA_contM)
```
...
```{r}
knitr::include_graphics(paste(graphs_path,"/logistic/Logistic_forestplotEPA_contm",".png",sep=""))
```
...
```{r,include=FALSE}
model_output_partial<-create_output_table(trainsplit = F,data_male_d,adjustments=partial_adjustments,outcome="prevalent_CHD_EPA",namew="partialF",type = "cat")

model_output_full<-create_output_table(trainsplit = F,data_male_d,adjustments=full_adjustments,outcome="prevalent_CHD_EPA",namew="fullF",type = "cat")
```
...
plot_FAR_gg(model_output_list,name=c("Partial","Full"),outcome="Prevalent_CHD_EPA_M",data=data_male_up)
```
