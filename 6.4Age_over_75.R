...
# data readin-------------------------------------------
data<-readRDS(paste(data_path,"FullData_standardisedPRS_75_16Jun2023.rds",sep="/"))
...
saveRDS(flex_table,paste(data_path,"/Prevalent_CHD_EPA_cont75_logistic_flex.rds",sep=""))
...
png(paste(graphs_path,"/logistic/Logistic_forestplotCHD_EPA_cont75",".png",sep=""), res = 200, width = a[1], height = a[2], units = "cm")
print(p)
dev.off()
...
plot_FAR_gg(model_output_list,name=c("Partial","Full"),outcome="Prevalent_CHD_EPA75",data = data)
...
saveRDS(flex_table,paste(data_path,"/Prevalent_CHD_EPO_cont75_logistic_flex.rds",sep=""))
...
png(paste(graphs_path,"/logistic/Logistic_forestplotCHD_EPO_cont75",".png",sep=""), res = 200, width = a[1], height = a[2], units = "cm")
print(p)
dev.off()
...
plot_FAR_gg(model_output_list,name=c("Partial","Full"),outcome="Prevalent_CHD_EPO75",data = data)
